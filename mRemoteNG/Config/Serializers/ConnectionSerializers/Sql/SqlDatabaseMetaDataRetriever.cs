...
CREATE TABLE [dbo].[tblCons] (
    ...
    [RedirectWebAuthn] bit NOT NULL,
    [EnableRdsAadAuth] bit NOT NULL,
    ...
    [InheritRedirectWebAuthn] bit NOT NULL,
    [InheritEnableRdsAadAuth] bit NOT NULL,
...
CREATE TABLE `tblCons` (
    ...
    `RedirectWebAuthn` tinyint NOT NULL,
    `EnableRdsAadAuth` tinyint NOT NULL,
    ...
    `InheritRedirectWebAuthn` tinyint NOT NULL,
    `InheritEnableRdsAadAuth` tinyint NOT NULL,
    ...
    `InheritUseRedirectionServerName` tinyint NOT NULL DEFAULT 0,
    ...
    `UseRedirectionServerName` tinyint NOT NULL DEFAULT 0,
